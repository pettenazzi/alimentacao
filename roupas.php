...
<div class="container">
    <div class="row">
        <div class="col p-3">
            <button class="btn btn-success" onclick="location.href='roupacarrinho.php'">Carrinho</button>
                ...
                while($row=$prod->fetch()){
                    ...
                    <div class="col p-3">
                        ...
                        <div class="card-body">
                            ...
                            <a href="roupacarrinho.php?add&id=<?php echo $row['prod_id'] ?>" class="btn btn-primary">Doar</a>
                        </div>
                        </div>
                    </div>
                    <?php
